  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <router-link tag="span" to="/">
      <a class="navbar-brand" href="#">
        <i class="fa fa-jsfiddle" aria-hidden="true"></i> VueStarter
        <sup>
          <span class="badge badge-pill badge-light">{{ $t('template') }}</span>
        </sup>
      </a>
    </router-link>
        ...
        <li class="nav-item">
          <router-link tag="span" to="/about">
            <a class="nav-link" href="#">
              <i class="fa fa-info-circle" aria-hidden="true"></i> {{$t('about')}}</a>
          </router-link>
        </li>
      </ul>
